...
public class simuladochamada extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_simuladochamada);
        ...
        public void onClick(View v) {
            switch (v.getId()){
                ...
                case R.id.btn_ligar:
                    ...
                    if(ActivityCompat.checkSelfPermission(simuladochamada.this, Manifest.permission.CALL_PHONE)
                            != PackageManager.PERMISSION_GRANTED){

                        ActivityCompat.requestPermissions(simuladochamada.this,
